        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-bold mb-1">In Immediate Danger?</h2>
              ...
              <motion.button
                ...
                className={`
                  ...
                  ${isSelected 
                    ...
                    : 'bg-white border hover:border-gray-300 hover:shadow'
                  }
                `}
              >
                <Icon className={`w-6 h-6 mx-auto mb-2 ${isSelected ? '' : 'text-gray-600'}`} />
                <p className={`text-xs font-medium ${isSelected ? '' : 'text-gray-700'}`}>
                  {cat.name}
                </p>
                <Badge 
                  variant="secondary" 
                  className={`mt-1 text-xs ${isSelected ? 'bg-white/20 text-white' : ''}`}
                >
                  {cat.count}
                </Badge>
              </motion.button>
