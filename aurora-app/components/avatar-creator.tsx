...
export function AvatarCreator({ open, onComplete, onSkip }: AvatarCreatorProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={() => {}}>
      <DialogContent className="max-w-2xl w-[95vw] h-[90vh] sm:h-auto sm:max-h-[85vh] p-0 bg-gradient-to-br from-[var(--color-aurora-violet)] to-[var(--color-aurora-purple)] border-0 flex flex-col">
        {/* Header - Fixed */}
        <div className="px-5 pt-5 pb-3 flex-shrink-0 border-b border-white/10">
