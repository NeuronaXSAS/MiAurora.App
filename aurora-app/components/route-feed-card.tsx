        ...
        <div className="flex items-center justify-between pt-3 border-t border-[var(--border)]">
          <div className="flex items-center gap-1">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="min-h-[40px] min-w-[40px] p-2 hover:bg-[var(--color-aurora-mint)]/20 hover:text-[var(--color-aurora-purple)]"
              onClick={(e) => {
                e.preventDefault();
                // TODO: Implement route voting
              }}
            >
            ...
            {/* Comments */}
            <Link href={`/routes/discover/${route._id}#comments`} onClick={(e) => e.stopPropagation()}>
              <Button
                variant="ghost"
                size="sm"
                className="min-h-[40px] min-w-[40px] p-2 hover:bg-[var(--color-aurora-lavender)]/30"
              >
            ...
            <Button
              variant="ghost"
              size="sm"
              className="min-h-[40px] min-w-[40px] p-2 hover:bg-[var(--color-aurora-pink)]/20"
              onClick={(e) => {
                e.preventDefault();
