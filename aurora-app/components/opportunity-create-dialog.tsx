    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Share a job, mentorship, resource, event, or funding opportunity with the community
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">
              Upload a logo or image to make your opportunity stand out
            </p>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-sm text-purple-900">
                  Share opportunities, build community
                </p>
                <p className="text-xs text-purple-700 mt-1">
                  Your opportunity will be visible to all users. They'll unlock it using credits to see full details.
                </p>
              </div>
            </div>
          </div>
