    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: isDev
              ? "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://www.googletagmanager.com https://pagead2.googlesyndication.com https://*.posthog.com https://us-assets.i.posthog.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://api.mapbox.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: blob: https: http:; media-src 'self' blob: https://res.cloudinary.com; connect-src 'self' https://*.convex.cloud https://api.mapbox.com https://events.mapbox.com https://*.posthog.com https://us.i.posthog.com https://us-assets.i.posthog.com https://api.search.brave.com https://generativelanguage.googleapis.com wss://*.convex.cloud; worker-src 'self' blob:; frame-src 'self' https://www.google.com https://checkout.stripe.com; frame-ancestors 'self';"
